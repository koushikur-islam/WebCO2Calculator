export default function FooterComponent() {
    return (<>
        <div className="text-center py-5 mb-[45px] md:mb-0" style={{ backgroundColor: '#222831' }}>
            <div className="limited-box md:mb-0" style={{ color: 'var(--muted-bg)' }}>
                ...
                <p className="py-2">
                    <i>Verify your website's carbon emission. Raise awareness for a better tomorrow.</i>
                </p>
            </div>
        </div>
